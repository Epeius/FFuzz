...
static VOID Handler{{d.checksum | hex}}(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)({{d.PsActiveProcessHead | hex}} - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = {{d._EPROCESS_ActiveProcessLinks | hex}};
    g_LfiKernelStructs.EProcessThreadListHeadOffset = {{d._EPROCESS_ThreadListHead | hex}};
    g_LfiKernelStructs.EThreadThreadListEntry = {{d._ETHREAD_ThreadListEntry | hex}};

    g_LfiKernelStructs.ObpCreateHandle = {{d.ObpCreateHandle | hex}} - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = {{d.MmAccessFault | hex}} - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = {{d.NtAllocateVirtualMemory | hex}} - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = {{d.NtFreeVirtualMemory | hex}} - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = {{d.NtProtectVirtualMemory | hex}} - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = {{d.NtMapViewOfSection | hex}} - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = {{d.NtUnmapViewOfSection | hex}} - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = {{d.MiUnmapViewOfSection | hex}} - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx = {{d.NtUnmapViewOfSectionEx | hex}} - KernelNativeBase + KernelLoadBase;
    ...
    g_LfiKernelStructs.KdCopyDataBlock = {{d.KdCopyDataBlock | hex}};
    g_LfiKernelStructs.KdpDataBlockEncoded = {{d.KdpDataBlockEncoded | hex}};

    g_LfiKernelStructs.PRCBProcessorStateOffset = (PVOID)(Command.Structs.KPRCB + {{d._KPRCB_ProcessorState | hex}});
