...
static VOID Handler0x752730(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    S2EMessage("Registering data structures for version ['10', '0', '9926', '0'] (64-bits)\n");
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x1402eaba0 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0x2f0;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x480;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x690;

    g_LfiKernelStructs.ObpCreateHandle = 0x1403f98e0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x1400401e0 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x140413d90 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x140417070 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x1404133d0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x140411e70 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x14040c15c - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x14040c220 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;
    ...
    g_LfiKernelStructs.KdCopyDataBlock = 0x1401bf990;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x140323e02;
...
static VOID Handler0x557f4d(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    S2EMessage("Registering data structures for version ['6', '1', '7601', '22616'] (64-bits)\n");
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x140226590 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0x188;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x308;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x428;

    g_LfiKernelStructs.ObpCreateHandle = 0x14036ff80 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x140080820 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x14036e140 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x1400607f0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x140390660 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x1403919f0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x1403900c4 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x14038fb70 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;

    /* Crash dump functionality */
    Command.Structs.KeBugCheckEx = 0x140167760; //KeBugCheck2
    Command.Structs.KdDebuggerDataBlock = 0x1401f00d0;
    g_LfiKernelStructs.KdCopyDataBlock = 0x140107cf0;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x140218122;
...
static VOID Handler0x204e7e(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x483158 - KernelNativeBase + KernelLoadBase);
    ...
    g_LfiKernelStructs.ObpCreateHandle = 0x4dbccc - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x445368 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x4c6dbe - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x4d1400 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x4d6a08 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x4d0480 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x4d1296 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x4d10d0 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;
    ...
    g_LfiKernelStructs.KdCopyDataBlock = 0x0;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x0;

    g_LfiKernelStructs.PRCBProcessorStateOffset = (PVOID)(Command.Structs.KPRCB + 0x1c);
...
static VOID Handler0x6aa6c8(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    S2EMessage("Registering data structures for version ['6', '2', '9200', '16384'] (64-bits)\n");
    ...
    g_LfiKernelStructs.ObpCreateHandle = 0x140448cf0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x1400b5620 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x140475070 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x1400eb910 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x140471e80 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x14046d590 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x1404023a8 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x14046e790 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;
...
static VOID Handler0x3c2f88(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    S2EMessage("Registering data structures for version ['6', '1', '7600', '16385'] (32-bits)\n");
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x538658 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0xb8;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x188;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x268;

    g_LfiKernelStructs.ObpCreateHandle = 0x611455 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x45eb87 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x6096e6 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x47ccec - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x63caf9 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x6361e3 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x658a4a - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x635e7c - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;

    /* Crash dump functionality */
    Command.Structs.KeBugCheckEx = 0x4d1b37; //KeBugCheck2
    Command.Structs.KdDebuggerDataBlock = 0x520be8;
    g_LfiKernelStructs.KdCopyDataBlock = 0x4cfdba;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x52e596;
...
static VOID Handler0x54b487(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    S2EMessage("Registering data structures for version ['6', '1', '7600', '16385'] (64-bits)\n");
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x14021fb30 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0x188;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x308;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x420;

    g_LfiKernelStructs.ObpCreateHandle = 0x140367270 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x14008bbe0 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x140370d50 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x1400b3680 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x14038b984 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x140388c00 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x1403881fc - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x140387ca0 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;

    /* Crash dump functionality */
    Command.Structs.KeBugCheckEx = 0x140167da0; //KeBugCheck2
    Command.Structs.KdDebuggerDataBlock = 0x1401e9070;
    g_LfiKernelStructs.KdCopyDataBlock = 0x140102fc0;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x14021144a;
...
static VOID Handler0x55ce0c(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    g_LfiKernelStructs.MmAccessFault = 0x14008d620 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x140377c90 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x14006d4d0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x140398b2c - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x1403999e0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x140397ad4 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x140397580 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;
...
static VOID Handler0x3c9503(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x540e98 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0xb8;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x188;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x268;

    g_LfiKernelStructs.ObpCreateHandle = 0x62268d - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x4857dd - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x64be0f - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x4b3821 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x67fc41 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x67eed7 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x67bcdc - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x67a25d - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;

    /* Crash dump functionality */
    Command.Structs.KeBugCheckEx = 0x4dd2d3; //KeBugCheck2
    Command.Structs.KdDebuggerDataBlock = 0x528be8;
    g_LfiKernelStructs.KdCopyDataBlock = 0x4db45e;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x536dd6;
...
static VOID Handler0x3c05d5(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x5396d8 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0xb8;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x188;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x268;

    g_LfiKernelStructs.ObpCreateHandle = 0x612bf0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x45ec98 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x60ae43 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x47d311 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x63e265 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x63794e - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x65a2c4 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x6375e8 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;

    /* Crash dump functionality */
    Command.Structs.KeBugCheckEx = 0x4d29eb; //KeBugCheck2
    Command.Structs.KdDebuggerDataBlock = 0x521c28;
    g_LfiKernelStructs.KdCopyDataBlock = 0x4d0c6e;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x52f616;
...
static VOID Handler0x2247c2(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    g_LfiKernelStructs.ObpCreateHandle = 0x48ded6 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x411e70 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x491fc3 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x4928ed - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x49acb1 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x49cb61 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x49c6e6 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x49c5ad - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;
...
static VOID Handler0x3c88ac(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x542f18 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0xb8;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x188;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x268;

    g_LfiKernelStructs.ObpCreateHandle = 0x624980 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x48e315 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x62ba62 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x4ba4db - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x644403 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x648394 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x66663a - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x64802e - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;

    /* Crash dump functionality */
    Command.Structs.KeBugCheckEx = 0x4df4e7; //KeBugCheck2
    Command.Structs.KdDebuggerDataBlock = 0x52ac28;
    g_LfiKernelStructs.KdCopyDataBlock = 0x4c9ab2;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x538e56;
...
static VOID Handler0x71fad2(UINT_PTR KernelLoadBase, UINT_PTR KernelNativeBase)
{
    ...
    S2EMessage("Registering data structures for version ['6', '3', '9600', '17031'] (64-bits)\n");
    ...
    g_LfiKernelStructs.PsActiveProcessHead = (PLIST_ENTRY)(0x1402b00a0 - KernelNativeBase + KernelLoadBase);
    g_LfiKernelStructs.EProcessActiveProcessLinkOffset = 0x2e8;
    g_LfiKernelStructs.EProcessThreadListHeadOffset = 0x470;
    g_LfiKernelStructs.EThreadThreadListEntry = 0x688;

    g_LfiKernelStructs.ObpCreateHandle = 0x1403f4d60 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MmAccessFault = 0x140067220 - KernelNativeBase + KernelLoadBase;

    g_LfiKernelStructs.NtAllocateVirtualMemory = 0x1403fd1c0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtFreeVirtualMemory = 0x14006d6c0 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtProtectVirtualMemory = 0x14044bbc4 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtMapViewOfSection = 0x1404811e8 - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.NtUnmapViewOfSection = 0x1403c7b2c - KernelNativeBase + KernelLoadBase;
    g_LfiKernelStructs.MiUnmapViewOfSection = 0x1403c7bd0 - KernelNativeBase + KernelLoadBase;
    //g_LfiKernelStructs.NtUnmapViewOfSectionEx =  - KernelNativeBase + KernelLoadBase;

    /* Crash dump functionality */
    Command.Structs.KeBugCheckEx = 0x1401dcaac; //KeBugCheck2
    Command.Structs.KdDebuggerDataBlock = 0x140297a20;
    g_LfiKernelStructs.KdCopyDataBlock = 0x1401d96d8;
    g_LfiKernelStructs.KdpDataBlockEncoded = 0x1402a31c1;
