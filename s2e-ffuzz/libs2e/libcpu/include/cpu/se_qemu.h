...
struct se_qemu_interface_t {
    ...
    struct tlb {
        ...
        void (*update_tlb_entry)(struct CPUX86State* env,
    ...
    struct libcpu {
        ...
        int (*ldl_p)(const void *host_addr);
        uint64_t (*ldq_p)(const void *host_addr);
    } libcpu;
    ...
    struct events {
        ...
        void (*on_translate_soft_interrupt_start)(
            void *context, struct TranslationBlock *tb, uint64_t pc, unsigned vector
        );

        /** Called by cpu_gen_code() at the beginning of translation process */
        void (*on_translate_block_start)(
            void *context, struct TranslationBlock *tb, uint64_t pc
        );
...
extern struct se_qemu_interface_t g_sqi;
