...
SINLINE uint32_t extractFloat16Frac(float16 a)
{
...
SINLINE int16 extractFloat16Exp(float16 a)
{
...
SINLINE flag extractFloat16Sign(float16 a)
{
...
SINLINE uint32_t extractFloat32Frac( float32 a )
{
...
SINLINE int16 extractFloat32Exp( float32 a )
{
...
SINLINE flag extractFloat32Sign( float32 a )
{
...
SINLINE float32 packFloat32( flag zSign, int16 zExp, uint32_t zSig )
{
...
SINLINE uint64_t extractFloat64Frac( float64 a )
{
...
SINLINE int16 extractFloat64Exp( float64 a )
{
...
SINLINE flag extractFloat64Sign( float64 a )
{
...
SINLINE float64 packFloat64( flag zSign, int16 zExp, uint64_t zSig )
{
...
SINLINE uint64_t extractFloatx80Frac( floatx80 a )
{
...
SINLINE int32 extractFloatx80Exp( floatx80 a )
{
...
SINLINE flag extractFloatx80Sign( floatx80 a )
{
...
SINLINE floatx80 packFloatx80( flag zSign, int32 zExp, uint64_t zSig )
{
    floatx80 z;
...
SINLINE uint64_t extractFloat128Frac1( float128 a )
{
...
SINLINE uint64_t extractFloat128Frac0( float128 a )
{
...
SINLINE int32 extractFloat128Exp( float128 a )
{
...
SINLINE flag extractFloat128Sign( float128 a )
{
...
SINLINE int float ## s ## _compare_internal( float ## s a, float ## s b,      \
...
SINLINE int floatx80_compare_internal( floatx80 a, floatx80 b,
                                      int is_quiet STATUS_PARAM )
{
    flag aSign, bSign;
...
SINLINE int float128_compare_internal( float128 a, float128 b,
                                      int is_quiet STATUS_PARAM )
{
    flag aSign, bSign;
...
SINLINE float ## s float ## s ## _minmax(float ## s a, float ## s b,     \
