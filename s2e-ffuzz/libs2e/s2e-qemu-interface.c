...
void init_s2e_qemu_interface(struct se_qemu_interface_t *sqi)
{
    ...
    sqi->exec.cleanup_tb_exec = s2e_qemu_cleanup_tb_exec;
    sqi->exec.finalize_tb_exec = s2e_qemu_finalize_tb_exec;
    ...
    sqi->exec.tb_exec = se_qemu_tb_exec;
    ...
    sqi->events.on_translate_special_instruction_end_signals_count = g_s2e_on_translate_special_instruction_end_signals_count;
