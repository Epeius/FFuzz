...
namespace klee {
  template<class K, class V, class KOV, class CMP, unsigned int NODE_CACHE_SIZE = 1024>
  class ImmutableTree {
  public:
  ...
  template<class K, class V, class KOV, class CMP, unsigned int NODE_CACHE_SIZE>
  void*
  ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE>::Node::cache[NODE_CACHE_SIZE];

  template<class K, class V, class KOV, class CMP, unsigned int NODE_CACHE_SIZE>
  unsigned
  ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE>::Node::cache_top = 0;
  ...
  template<class K, class V, class KOV, class CMP, unsigned int NODE_CACHE_SIZE>
  inline typename ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE>::Node *ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE>::Node::incref() {
    ++references;
    return this;
  }
  ...
  template<class K, class V, class KOV, class CMP, unsigned int NODE_CACHE_SIZE>
  ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE>::ImmutableTree(Node *_node)
    : node(_node) {
  }

  template<class K, class V, class KOV, class CMP, unsigned int NODE_CACHE_SIZE>
  ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE>::ImmutableTree(const ImmutableTree &s)
    : node(s.node->incref()) {
  }
  ...
  template<class K, class V, class KOV, class CMP, unsigned int NODE_CACHE_SIZE>
  ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE> &ImmutableTree<K,V,KOV,CMP, NODE_CACHE_SIZE>::operator=(const ImmutableTree &s) {
