...
namespace klee {
  ...
  public:
    ...
    void getRanges(const ConstraintManager &constraints, const std::vector<const Array *> &symbObjects,
                   ref<Expr> e, ref<Expr> start, ref<Expr> end, std::vector<Range>& ranges);
  ...
  public:
      ExternalSolver(const std::string &logFile);
  };
