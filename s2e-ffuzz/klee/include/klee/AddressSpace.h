...
namespace klee {
    ...
    protected:
        ...
        void updateWritable(const MemoryObject *mo,
    ...
    public:
        ...
        AddressSpaceBase(const AddressSpaceBase &b) :
        ...
        virtual ObjectState *getWriteable(const MemoryObject *mo,
                                          const ObjectState *os) {
            assert(!os->readOnly);
    ...
    public:
        ...
        bool splitMemoryObject(ExecutionState &state,
