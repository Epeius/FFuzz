...
SpecialFunctionHandler::readStringAtAddress(ExecutionState &state, 
  ...
  bool res;
  assert(executor._solver(state)->mustBeTrue(state,
...
void SpecialFunctionHandler::handleAssume(ExecutionState &state,
  ...
  bool res;
  bool success = executor._solver(state)->mustBeFalse(state, e, res);
...
void SpecialFunctionHandler::handlePrintRange(ExecutionState &state,
  ...
  if (!isa<ConstantExpr>(arguments[1])) {
    ...
    bool success = executor._solver(state)->getValue(state, arguments[1], value);
    assert(success && "FIXME: Unhandled solver failure");
    bool res;
    success = executor._solver(state)->mustBeTrue(state,
    ...
    if (res) {
      ...
      std::pair< ref<Expr>, ref<Expr> > res =
        executor._solver(state)->getRange(state, arguments[1]);
...
void SpecialFunctionHandler::handleMakeSymbolic(ExecutionState &state,
  ...
  for (Executor::ExactResolutionList::iterator it = rl.begin(), 
    ...
    bool res;
    bool success =
      executor._solver(state)->mustBeTrue(*s,
