...
public:
    ...
    static void InjectArray(llvm::Module *m,
...
private:
    ...
    void generateIndirectJump(llvm::IRBuilder<> &builder,
                              LLVMBasicBlockMap &allBbs,
                              uint64_t bbPc);
...
public:
    RevGen(const std::string &binary,
    ...
    void translate(const llvm::BinaryFunctions &functions,
                   const llvm::BinaryBasicBlocks &tbs);
