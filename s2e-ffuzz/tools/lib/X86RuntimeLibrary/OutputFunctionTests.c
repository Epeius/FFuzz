...
static void push_base_params(uint8_t *stack, output_params_t *param_types, int param_count,
                             int test_fd, uintptr_t fmt, int test_len, uintptr_t out_len, int *check_length)
{
...
static char detect_format_char(revgen_function_t func, uint8_t *stack,
                               output_params_t *param_types, int param_count)
{
...
static unsigned detect_integer_formats(revgen_function_t func, uint8_t *stack,
                                       output_params_t *param_types, int param_count,
                                       char format_char)
{
    unsigned ret = 0;

    struct format_test_t formats [] = {
        { 1234, "d", "1234", FORMAT_d},
...
static unsigned detect_width_arguments(revgen_function_t func, uint8_t *stack,
                                       output_params_t *param_types, int param_count,
                                       char format_char)
{
...
static unsigned detect_max_direct_arguments(revgen_function_t func, uint8_t *stack,
                                            output_params_t *param_types, int param_count,
                                            char format_char)
{
...
static void detect_output_fcn(revgen_function_t func, uint64_t func_addr,
                              uint8_t *stack, volatile bool *result, FILE *fp,
                              output_params_t *param_types, int param_count)
{
    const char *test_string = "098asfd80c";
    ...
    if (strncmp(g_syscall_transmit_data, test_string, actual_length) != 0) {
        printf("    invalid output %.*s of size %i\n", g_syscall_transmit_size, g_syscall_transmit_data, g_syscall_transmit_size);
        return;
    }
    ...
    *result = true;
    ...
    for (int i = 0; i < param_count; ++i) {
        switch (param_types[i]) {
            case PARAM_STRING: fprintf(fp, "\"string\","); break;
            case PARAM_LENGTH: fprintf(fp, "\"length\","); break;
            case PARAM_FD: fprintf(fp, "\"fd\",");  break;
            case PARAM_OUT_LEN: fprintf(fp, "\"out_len\",");  break;
        }
    }
...
void detect_output_str(revgen_function_t func, uint64_t func_addr,
                       uint8_t *stack, volatile bool *result, FILE *fp)
{
    printf("Trying %s\n", __FUNCTION__);
...
void detect_output_str_len(revgen_function_t func, uint64_t func_addr,
                       uint8_t *stack, volatile bool *result, FILE *fp)
{
    printf("Trying %s\n", __FUNCTION__);
...
void detect_output_fd_str(revgen_function_t func, uint64_t func_addr,
                       uint8_t *stack, volatile bool *result, FILE *fp)
{
    printf("Trying %s\n", __FUNCTION__);
...
void detect_output_fd_str_len(revgen_function_t func, uint64_t func_addr,
                       uint8_t *stack, volatile bool *result, FILE *fp)
{
    printf("Trying %s\n", __FUNCTION__);
...
void detect_output_fd_str_len_outlen(revgen_function_t func, uint64_t func_addr,
                       uint8_t *stack, volatile bool *result, FILE *fp)
{
    printf("Trying %s\n", __FUNCTION__);
