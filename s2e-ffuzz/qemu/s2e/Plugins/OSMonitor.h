...
public:
   ...
   sigc::signal<void, S2EExecutionState*, uint64_t /* cr3 */, uint64_t /* pid */, const std::string & /*ImageName*/ > onProcessLoad;
...
public:
   virtual bool getEntryPoint(S2EExecutionState *s, const ModuleDescriptor &desc, uint64_t &addr) { return false; }
   virtual bool getImports(S2EExecutionState *s, const ModuleDescriptor &desc, vmi::Imports &I) = 0;
   virtual bool getExports(S2EExecutionState *s, const ModuleDescriptor &desc, vmi::Exports &E) = 0;
   virtual bool getRelocations(S2EExecutionState *s, const ModuleDescriptor &desc, vmi::Relocations &R) = 0;
   virtual bool getSections(S2EExecutionState *s, const ModuleDescriptor &desc, vmi::Sections &S) { return false; }
