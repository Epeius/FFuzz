...
S2E_DEFINE_PLUGIN(EdgeKiller, "Kills states that encounter a given (start_pc, end_pc) edge", "", "EdgeDetector", "ModuleExecutionDetector");
...
{
    getDebugStream() << "EdgeKiller: adding edge " << moduleName
