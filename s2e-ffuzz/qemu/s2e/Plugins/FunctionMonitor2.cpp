...
S2E_DEFINE_PLUGIN(FunctionMonitor2, "Function monitoring plugin", "", "ExecutionTracer", "ProcessExecutionDetector", "Interceptor", "ModuleMap");
...
void FunctionMonitor2::initialize()
{
    ...
    s2e()->getCorePlugin()->onTranslateBlockEnd.connect(
                    sigc::mem_fun(*this, &FunctionMonitor2::onTranslateBlockEnd));
}

void FunctionMonitor2::onTranslateBlockEnd(ExecutionSignal *signal,
