...
template <typename RET, typename BE1, typename BE2, typename A1, typename B1, typename A2, typename B2, typename A3, typename B3>
inline functor_base<RET, BE1, BE2, nil, nil, nil, nil, nil>*
bind(functor_base<RET, BE1, BE2, A1, A2, A3, nil, nil> *f, B1 a1, B2 a2, B3 a3) {
