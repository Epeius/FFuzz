...
Avoids cumbersome reboots when working with S2E.
ETEXI
...
DEF("mon-cmd-on-reboot", HAS_ARG, QEMU_OPTION_mon_cmd_on_reboot, \
    "-mon-cmd-on-reboot [cmds]\n" \
    "                execute monitor commands on machine reboot\n",
    QEMU_ARCH_ALL)
STEXI
@item -mon-cmd-on-reboot @var{cmds}
@findex -mon-cmd-on-reboot
Execute monitor commands on machine reboot. Multiple commands can be separated
with ; or newlines.
ETEXI
...
DEF("periodic-screenshot", HAS_ARG, QEMU_OPTION_periodic_screenshot, \
    "-periodic-screenshot folder_name\n" \
    "                periodically save a screenshot to the specified folder\n",
    QEMU_ARCH_ALL)
STEXI
...
DEF("eject-on-reboot", HAS_ARG, QEMU_OPTION_eject_on_reboot, \
    "-eject-on-reboot [device]\n" \
    "                eject device on machine reboot\n",
    QEMU_ARCH_ALL)
STEXI
@item -eject-on-reboot @var{device}
@findex -eject-on-reboot
Eject device on machine reboot
ETEXI
...
DEF("s2e-unbuffered-stream", 0, QEMU_OPTION_s2e_unbuffered_stream,
    "-s2e-unbuffered-stream    disable output stream buffer\n", QEMU_ARCH_ALL)
