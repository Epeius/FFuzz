...
LINK = $(call quiet-command,$(CXX) $(QEMU_CFLAGS) $(CFLAGS) $(ASAN_FLAGS) $(LDFLAGS) -o $@ $(sort $(1)) $(LIBS),"  LINK  $(TARGET_DIR)$@")
...
%.bc: %.c $(GENERATED_HEADERS)
	$(call quiet-command,$(CC) $(filter-out -g -Wold-style-declaration -ftest-coverage -fprofile-arcs, $(QEMU_INCLUDES) $(QEMU_CFLAGS) $(QEMU_DGFLAGS) $(CFLAGS)) -c -DSYMBEX_LLVM_LIB -emit-llvm -o $@ $<,"  LLVMCC    $(TARGET_DIR)$@")
